...
ActiveRecord::Schema.define(version: 20140708071435) do
  ...
  add_index "angels", ["id"], name: "index_angels_on_id", using: :btree
  ...
  add_index "audits", ["association_id", "association_type"], name: "association_index", using: :btree
  ...
  add_index "emails", ["email_name_id"], name: "index_emails_on_email_name_id", using: :btree
  ...
  add_index "event_emails", ["email_name_id"], name: "index_event_emails_on_email_name_id", using: :btree
  add_index "event_emails", ["event_id"], name: "index_event_emails_on_event_id", using: :btree
  ...
  add_index "members", ["angel_id"], name: "index_members_on_angel_id", using: :btree
  add_index "members", ["gender"], name: "index_members_on_gender", using: :btree
  add_index "members", ["membership_id"], name: "index_members_on_membership_id", using: :btree
  ...
  add_index "memberships", ["angel_id"], name: "index_memberships_on_angel_id", using: :btree
  add_index "memberships", ["status"], name: "index_memberships_on_status", using: :btree
  ...
  add_index "registrations", ["angel_id"], name: "index_registrations_on_angel_id", using: :btree
  add_index "registrations", ["event_id", "role"], name: "index_registrations_on_role", using: :btree
  add_index "registrations", ["event_id"], name: "index_registrations_on_event_id", using: :btree
  add_index "registrations", ["gender"], name: "index_registrations_on_gender", using: :btree
  add_index "registrations", ["id"], name: "index_registrations_on_id", using: :btree
  add_index "registrations", ["status"], name: "index_registrations_on_status", using: :btree
