...
describe Office::TeamsController do
  ...
  let(:valid_attributes) { { name: 'Level 1', date: Date.current } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # TeamsController. Be sure to keep this updated too.
  let(:valid_session) { {"warden.user.staff.key" => session["warden.user.staff.key"]} }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "redirects to the created team" do
        post :create, {:team => valid_attributes}, valid_session
        response.should redirect_to([:office, Team.last])
      end
    end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the team" do
        team = Team.create! valid_attributes
        put :update, {:id => team.to_param, :team => valid_attributes}, valid_session
        response.should redirect_to([:office, team])
      end
    end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the teams list" do
      team = Team.create! valid_attributes
      delete :destroy, {:id => team.to_param}, valid_session
      response.should redirect_to(office_teams_url)
    end
  end
